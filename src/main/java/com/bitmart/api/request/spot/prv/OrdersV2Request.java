...
public class OrdersV2Request extends CloudRequest {
    ...
    @ParamKey("status")
    private OrderStatus status;  //1=Order failure;2=Order success;3=Freeze failure;4=Freeze success;5=Partially filled;6=Fully filled;7=Canceling;8=Canceled;9=Outstanding (4 and 5);10= 6 and 8
